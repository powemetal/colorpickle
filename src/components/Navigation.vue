    ...
    <div class="flex transition">
      ...
      <div class="flex items-start justify-end m-4 w-full">
        <div class="flex">
            ...
            <button @click="recupererCouleurPick" class="flex bg-black/20 cursor-pointer rounded-3xl w-18 h-12 justify-center items-center mx-2 hover:border-4 hover:border-solid hover:border-black/10"
            :style="{
              backgroundColor: estFonce(r,g,b)
                ? 'rgba(256,256,256,0.2)'
                : 'rgba(0,0,0,0.2)'
          ...
          <RouterLink :to="{ name: 'palettes' }">
            ...
            <button @click="useMessage().afficherMessage(messageSauvegarde)" class="flex bg-black/20 cursor-pointer rounded-3xl w-18 h-12 justify-center items-center mx-2  hover:border-4 hover:border-solid hover:border-black/10"
            :style="{
              backgroundColor: estFonce(r,g,b)
                ? 'rgba(256,256,256,0.2)'
                : 'rgba(0,0,0,0.2)'
            }">
              <i class=" fa-solid fa-floppy-disk mix-blend-overlay fa-2xl cursor-pointer"
              :style="{color: 'white'}">
              </i>
            </button>
